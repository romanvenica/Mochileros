        ...
        <div class="marco_escala">
          ...
          <div class="row">
            <div class="col-xs-6">
                ...
                <!--################## IDIOMAS ###############-->
                <datalist id="idioma">
                  <option data-value="0" value="Afrikaans">
                  <option data-value="1" value="Akan">
                  <option data-value="2" value="Albanes">
                  <option data-value="3" value="Aleman">
                  <option data-value="4" value="Amharico">
                  <option data-value="5" value="arabe">
                  <option data-value="6" value="Armenio">
                  <option data-value="7" value="Asames">
                  ...
                  <option data-value="13" value="Bengali">
                  ...
                  <option data-value="19" value="Bulgaro">
                  <option data-value="20" value="Cachemir">
                  <option data-value="21" value="Caldeo">
                  <option data-value="22" value="Camboyano">
                  <option data-value="23" value="Canares">
                  <option data-value="24" value="Cantones">
                  <option data-value="25" value="Catalan">
                  ...
                  <option data-value="34" value="Chuukes">
                  <option data-value="35" value="Cingales">
                  <option data-value="36" value="Cingales">
                  ...
                  <option data-value="42" value="Danes">
                  <option data-value="43" value="Dari">
                  ...
                  <option data-value="52" value="Ewe">
                  <option data-value="53" value="Fante">
                  <option data-value="54" value="Farsi">
                  <option data-value="55" value="Feroes">
                  <option data-value="56" value="Fines">
                  <option data-value="57" value="Flamenco">
                  <option data-value="58" value="Frances">
                  <option data-value="59" value="Frances canadiense">
                  <option data-value="60" value="Frison">
                  <option data-value="61" value="Fujianes">
                  ...
                  <option data-value="68" value="Gaelico">
                  <option data-value="69" value="Gales">
                  ...
                  <option data-value="78" value="Hassania">
                  <option data-value="79" value="Hausa">
                  <option data-value="80" value="Hebreo">
                  <option data-value="81" value="Hiligainon">
                  <option data-value="82" value="Hindi">
                  <option data-value="83" value="Hindi de Fiyi">
                  <option data-value="84" value="Hindu">
                  <option data-value="85" value="Hmong">
                  <option data-value="86" value="Holandes">
                  <option data-value="87" value="Hungaro">
                  ...
                  <option data-value="93" value="Ingles">
                  <option data-value="94" value="Inuit">
                  <option data-value="95" value="Irlandes">
                  <option data-value="96" value="Islandes">
                  <option data-value="97" value="Italiano">
                  <option data-value="98" value="Jalja">
                  <option data-value="99" value="Japones">
                  <option data-value="100" value="Javanes">
                  ...
                  <option data-value="106" value="Kinaruanda">
                  <option data-value="107" value="Kirguis">
                  ...
                  <option data-value="116" value="Latin">
                  <option data-value="117" value="Leton">
                  ...
                  <option data-value="123" value="Luxemburgues">
                  ...
                  <option data-value="130" value="Maltes">
                  <option data-value="131" value="Mandarin">
                  <option data-value="132" value="Mandinga">
                  <option data-value="133" value="Mandingo">
                  <option data-value="134" value="Maori">
                  <option data-value="135" value="Marati">
                  <option data-value="136" value="Marshales">
                  ...
                  <option data-value="144" value="Nepali">
                  ...
                  <option data-value="179" value="Somali">
                  <option data-value="180" value="Sondanes">
                  <option data-value="181" value="Soninke">
                  ...
                  <option data-value="188" value="Tailandes">
                  <option data-value="189" value="Taiwanes">
                  <option data-value="190" value="Tamil">
                  <option data-value="191" value="Tayiko">
                  <option data-value="192" value="Telugu">
                  <option data-value="193" value="Tibetano">
                  <option data-value="194" value="Tigrina">
                  ...
                  <option data-value="201" value="Urdu">
                  ...
                  <option data-value="206" value="Wolof">
                  <option data-value="207" value="Xhosa">
                  <option data-value="208" value="Yakartanes">
                  ...
                  <option data-value="213" value="Zulu">
                </datalist>
            </div>
